...
export default function MessageBubble({ message }: MessageBubbleProps) {
	...
	return (
		<div
			className={`flex items-start gap-2.5 mb-4 animate-slide-in ${
		...
		>
			...
			{/* Message Bubble */}
			<div
				className={`flex flex-col max-w-[75%] sm:max-w-[65%] min-w-0 ${
			...
			>
				...
				<div className={`text-xs mt-1.5 px-1 ${isUser ? 'text-gray-500' : 'text-gray-600'}`}>
					{time}
				</div>
			</div>
		</div>
